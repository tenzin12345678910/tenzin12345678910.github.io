...
document.getElementById('playButton').addEventListener('click', (clickEvent) => {
  ...
  if(!audioEl.src) {
    ...
    spotifyApi.searchTracks('cyanide', {limit: 1})
      .then((results) => {
        let previewUrl = "https://p.scdn.co/mp3-preview/f46092682053fdc38645a6e3379e25aed6b970aa?cid=2afca98576b4421595a2802803d0b92a"//NEED TO ADD  SOMETHING THERWEJEHWKJDn
        if (previewUrl) {
